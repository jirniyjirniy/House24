# -*- coding: utf-8 -*-
# Generated by Django 4.2.1 on 2024-05-02 15:21
...
import src.admin_panel.utilities
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=src.admin_panel.utilities.get_timestamp_path,
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("new", "Новый"), ("active", "Активен"), ("disabled", "Отключен")],
                        default="new",
                        max_length=50,
                        verbose_name="Статус",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "debit_credit",
                    models.CharField(
                        choices=[("plus", "Приход"), ("minus", "Расход")],
                        default="plus",
                        max_length=100,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gallery",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.gallery"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="admin_panel.gallery",
                    ),
                ),
                (
                    "seo",
                    models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.seo"),
                ),
            ],
            options={
                "db_table": "tarif_site",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("currency", models.CharField(blank=True, default="грн", max_length=10, verbose_name="Валюта")),
                (
                    "service",
                    models.ForeignKey(
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "house",
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.house"),
                ),
            ],
            options={
                "db_table": "section",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "receipt",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.receipt"
                    ),
                ),
                (
                    "service",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.tariffsystem"
            ),
        ),
        migrations.CreateModel(
            name="Photo",
            fields=[
                ...
                (
                    "img",
                    models.ImageField(
                        blank=True, null=True, upload_to=src.admin_panel.utilities.get_timestamp_path, verbose_name=""
                    ),
                ),
                (
                    "gallery",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("active", "Активен"), ("disabled", "Не активен")],
                        default="active",
                        max_length=50,
                        verbose_name="Статус",
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "article",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, to="admin_panel.article"
                    ),
                ),
                (
                    "flat_owner",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, to="admin_panel.flatowner"
                    ),
                ),
                (
                    "personal_account",
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="admin_panel.personalaccount",
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="admin_panel.personal"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "flat",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.flat"
                    ),
                ),
                ...
                (
                    "floor",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.floor"
                    ),
                ),
                (
                    "house",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.house"
                    ),
                ),
                (
                    "section",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.section"
                    ),
                ),
                (
                    "sender",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.personal"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gallery",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, to="admin_panel.gallery"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "indication_val",
                    models.DecimalField(
                        blank=True, decimal_places=1, default=0.0, max_digits=6, verbose_name="Показания"
                    ),
                ),
                ("date_published", models.DateField()),
                (
                ...
                (
                    "flat",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="admin_panel.flat", verbose_name="Квартира"
                    ),
                ),
                (
                    "service",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.personal"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="floor",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.floor", verbose_name="Этаж"
            ),
        ),
        migrations.AddField(
            model_name="flat",
            name="house",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.house", verbose_name="Дом"
            ),
        ),
        migrations.AddField(
            model_name="flat",
            name="section",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="admin_panel.section", verbose_name="Секция"
            ),
        ),
        migrations.AddField(
            model_name="flat",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.SET_NULL, to="admin_panel.personal"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        blank=True, null=True, upload_to="docs", verbose_name="PDF, JPG (макс. размер 20 Mb)"
                    ),
                ),
                ...
                (
                    "about_us",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="admin_panel.aboutus"
                    ),
                ),
            ],
            options={
